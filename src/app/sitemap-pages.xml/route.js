...
export async function GET() {
  ...
  const staticPages = [
    ...
    { path: '/punjab-job-portal', priority: '0.95', changefreq: 'daily' },
    { path: '/sindh-job-portal', priority: '0.95', changefreq: 'daily' },
    { path: '/national-job-portal', priority: '0.95', changefreq: 'daily' },
    { path: '/kpk-job-portal', priority: '0.9', changefreq: 'daily' },
    { path: '/balochistan-job-portal', priority: '0.9', changefreq: 'daily' },
