...
const portalKey = 'national-job-portal';
...
export default function NationalJobPortalPage() {
  ...
  const itemListSchema = generateItemListSchema(activeJobs.slice(0, 30), siteUrl);
