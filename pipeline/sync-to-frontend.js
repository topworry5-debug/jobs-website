/**
 * RozgarPK — Live Pipeline Sync to Frontend Store
...
async function sync() {
  console.log("[RozgarPK Sync] Running live government scrapers to generate frontend store...");
  ...
  console.log(`[RozgarPK Sync] Successfully saved ${result.updatedActiveJobs.length} live verified jobs to ${outputPath}`);
}
