    ...
    while ((itemMatch = productItemRegex.exec(html)) !== null) {
      ...
      if (rawTitle && isJobOpportunity) {
        scrapedJobs.push({
          ...
          city: rawTitle.toLowerCase().includes('karachi') ? 'Karachi' : (rawTitle.toLowerCase().includes('islamabad') ? 'Islamabad' : (rawTitle.toLowerCase().includes('lahore') ? 'Lahore' : 'Multiple Districts')),
          province: rawTitle.toLowerCase().includes('sindh') || rawTitle.toLowerCase().includes('tharparkar') || rawTitle.toLowerCase().includes('hyderabad') || rawTitle.toLowerCase().includes('umerkot') ? 'Sindh' : (rawTitle.toLowerCase().includes('punjab') || rawTitle.toLowerCase().includes('jhang') || rawTitle.toLowerCase().includes('lahore') ? 'Punjab' : 'Federal'),
